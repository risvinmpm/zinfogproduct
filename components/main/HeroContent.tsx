...
const HeroContent = () => {
  return (
    <motion.section
      initial="hidden"
      animate="show"
      className="w-full pt-20 pb-10 overflow-hidden relative"
    >
      <div className="flex flex-col md:flex-row items-center justify-between max-w-[1300px] mx-auto relative z-10">
        {/* Left Content */}
        ...
        {/* Right Spline Animation - Vertically Centered */}
        <motion.div
          variants={slideInFromRight(0.5)}
          className="relative w-full md:w-1/2 h-[500px] md:h-[700px] z-0"
        >
          <div className="absolute top-1/2 right-[-100px] transform -translate-y-1/2 w-[750px] h-[750px] scale-125">
